...
export default async function GSUnidadesPage() {
  ...
  let erro = "";
  try {
    rows = await gsList("gs_unidades", { colunas: "id,nome,cnpj,tipo,ativo", ordem: "nome" });
