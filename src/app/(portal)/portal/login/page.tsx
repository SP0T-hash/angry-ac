...
export default function PortalLogin() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 sm:p-12 relative z-20 font-sans">
      ...
      {/* Card */}
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl p-8 shadow-card relative overflow-hidden">
        ...
        <form onSubmit={handleLogin} className="grid gap-6 text-left">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full mt-6 py-4 bg-slate-900 text-white rounded-xl font-black uppercase tracking-[0.2em] text-[11px] hover:bg-emerald-600 hover:shadow-lg hover:shadow-emerald-200 transition-all flex items-center justify-center gap-3 group disabled:opacity-50"
          >
            {loading ? (
